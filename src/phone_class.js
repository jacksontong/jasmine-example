...
MobilePhone.prototype.mobileRating = function (brand, platform) {
    var reviewRating = '****';
    // Logic will be implemented later by collecting data/review from a third party system
    return reviewRating;
};
...
MobilePhone.prototype.mobilePrice = function (callback) {
    // Let's use hard coed values for demonstration purpose
    // In Javascript there is rounding errors.
    // Always calculate in cents not dollors.
    var price = (50.0 * 100);
    var tax = price * 6;
    price = (price + tax) / 100;
