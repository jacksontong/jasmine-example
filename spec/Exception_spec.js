describe('Javascript Exceptions: ', function () {
    describe('Validate Errors:', function () {
        ...
        it('Error should be thrown on passing any unexpected or wrong arguments', function () {
            /*Assertions to test parameters of addTwonumbers() function */
        ...
        it('Error messages should be consistent throughout the application', function () {
            ...
            expect(function () {
                generateMaxValue(5000);
            }).toThrowError('Maximum value should be between 0 and 1000');
        });
    });
});