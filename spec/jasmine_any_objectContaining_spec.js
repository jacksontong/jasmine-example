describe('jasmine.any', function () {
    it('should be applied successfully for comparing arguments', function () {
        ...
        var myMobile = new MobilePhone('Samsung', 'White', '8 Megapixels', mydate.toDateString(), ["Android", "Lollipop","1.2 GHz Quad Core "]);
    ...
    describe('jasmine.objectContaining', function () {
        it('should match/compare objects corresponding to keys/values pairs in the actual', function () {
            var mydate = new Date('11/20/2014'); // mm//dd//yyyy
            var myMobile = new MobilePhone('Samsung', 'White', '8 Megapixels', mydate.toDateString(), ["Android", "Lollipop","1.2 GHz Quad Core"]);
