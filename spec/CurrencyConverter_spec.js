describe('<ABC> Money Exchange Company: Currency Converter Module', function () {
    describe('When Convert The Currency', function () {
        describe('Across The Continents, ', function () {
            describe('For Asian countries. Then: ', function () {
            ...
            describe('For European Countries. Then: ', function () {
            ...
            describe('For African Countries. Then: ', function () {
            ...
            describe('For North America Countries. Then: ', function () {
